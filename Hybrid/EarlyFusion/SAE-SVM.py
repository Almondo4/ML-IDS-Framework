...
DataTrain = pd.read_pickle("../../Data/Hybrid_Testing.csv")
...
dynamicModel = keras.models.load_model("../../Hybrid/SAE_DLHI_2.h5")
...
model = SVC(kernel='rbf', random_state = 1, verbose=3)
